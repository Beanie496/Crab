...
type RaysBetween = [[Bitboard; 64]; 64];

/// A table of base late move reductions.
///
/// Generated by the build script.
// SAFETY: this file is a transmutation from `BaseReductions`
...
// SAFETY: this file is a transmutation from `RaysBetween`
static RAYS_BETWEEN: RaysBetween =
